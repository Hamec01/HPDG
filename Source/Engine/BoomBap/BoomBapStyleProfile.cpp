...
const std::array<BoomBapStyleProfile, 8>& getBoomBapProfiles()
{
    static const std::array<BoomBapStyleProfile, 8> profiles = {{
        { "Classic", BoomBapSubstyle::Classic, 56.0f, 1.00f, 0.82f, 0.72f, 0.72f, 0.62f, 0.16f, 0.12f, 0.12f, 0.82f, 0.03f, 0.18f, 94, 0.14f, 0.84f, 0.03f, 0.13f, 18, 10, 22, 8, 4, 10, 88, 110, 92, 112, 84, 104, 54, 90, 82, 106, 48, 82, 24, 46, 0.0f, 0.0f, 0.44f, 0.32f, 0.26f, 0.10f, 0.74f, 0.14f },
